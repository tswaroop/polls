$(function(){
  ...
  d3.csv('data/polls.csv', function(data){
    ...
    var data = _.filter(data, function(d){ return d.STATE == state_name_hindi_reverse[state] })
  ...
  $('.gotoagency').on('click', function(){
    ...
    window.location = "/agencyhindi?state="+state_name_hindi_reverse[_st]
  })
...
function drawAnalysis(data){
  ...
  x_scale.domain([0, total_seats[state_name_hindi_reverse[state]]])

  var path = svg.append('line')
       .attr('x1', x_scale(total_seats[state_name_hindi_reverse[state]]/2))
       .attr('y1', 180)
       .attr('x2', x_scale(total_seats[state_name_hindi_reverse[state]]/2))
       .attr('y2', 545)
  ...
  var n18btn = svg.append('g').attr('class','netws18btn')
                  ...
                  .on('click', function(){
                    ...
                    window.location = "/nethindi?state="+state_name_hindi_reverse[_state]
                  });
  ...
  parties_repr.append('text')
              ...
              .text(function(d){ return party_hindi[d.party] || d.party })
  ...
  agencies_repr.append('text')
              ...
              .text(function(d){ return agency_alias_hindi_poll[d.agency.split('-').join(' ')] || d.agency.split('-').join(' ') })
              .attr('dx',100)
  ...
  svg.append('text')
     .attr('x', x_scale(Math.floor(total_seats[state_name_hindi_reverse[state]]/2)+1) - 2)
     .attr('y', 165)
     .attr('text-anchor', 'middle')
     .text('बहुमत ' + (Math.floor(total_seats[state_name_hindi_reverse[state]]/2)+1))
